...
export default function LoginPage() {
    ...
    return (
        <form className="w-full mt-6" onSubmit={handleSubmit}>
            {(successMessage || registeredMessage) && !isLoading && (
            ...
            <div className="pb-3">
                <div className="flex border-b border-[#54473b] justify-between">
                    <Link
                        ...
                        href="/login"
                    >
                        <p className="text-white text-sm font-bold leading-normal tracking-[0.015em]">Logowanie</p>
                    </Link>
                    <Link
                        className="flex flex-col items-center justify-center border-b-[3px] border-b-transparent text-[#baab9c] pb-[13px] pt-4 flex-1"
                        href="/register"
                    >
                        <p className="text-[#baab9c] text-sm font-bold leading-normal tracking-[0.015em]">Rejestracja</p>
                    </Link>
                </div>
            </div>
