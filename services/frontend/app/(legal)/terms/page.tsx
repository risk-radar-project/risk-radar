          ...
          <div className="space-y-12">
            <section id="postanowienia-ogolne" className="scroll-mt-20">
              ...
              <p className="leading-relaxed text-zinc-300">
                ...
                internetowej RiskRadar, dostępnej pod adresem riskradar.pl.
                Administratorem aplikacji jest RiskRadar Sp. z o.o. z siedzibą w
                Warszawie.
              </p>
            </section>
            ...
            <section id="definicje" className="scroll-mt-20">
              ...
              <ul className="list-disc space-y-3 pl-6 text-zinc-300">
                <li>
                  <strong className="text-white">Aplikacja</strong> - aplikacja
                  internetowa RiskRadar.
                </li>
                <li>
                  <strong className="text-white">Użytkownik</strong> - osoba
                  fizyczna korzystająca z Aplikacji.
                </li>
                <li>
                  <strong className="text-white">Konto</strong> - indywidualny
                  panel Użytkownika w Aplikacji.
                </li>
              </ul>
            </section>
            ...
            <section id="konto" className="scroll-mt-20">
              ...
              <p className="leading-relaxed text-zinc-300">
                Korzystanie z pełni funkcjonalności Aplikacji wymaga założenia
                Konta. Użytkownik zobowiązany jest do podania prawdziwych danych
                podczas rejestracji. Użytkownik jest odpowiedzialny za
            ...
            <section id="uslugi" className="scroll-mt-20">
              ...
              <p className="leading-relaxed text-zinc-300">
                Aplikacja umożliwia wizualizację zgłoszonych zagrożeń na mapie
                miasta. Zgłoszenia mogą być dodawane przez zarejestrowanych
                Użytkowników.
              </p>
            </section>
            ...
            <section id="zasady-korzystania" className="scroll-mt-20">
              ...
              <p className="leading-relaxed text-zinc-300">
                Zabronione jest dodawanie treści niezgodnych z prawem,
                wulgarnych, obraźliwych oraz wprowadzających w błąd.
                Administrator zastrzega sobie prawo do usuwania takich treści
                oraz blokowania kont Użytkowników łamiących regulamin.
              </p>
            </section>
            ...
            <section id="odpowiedzialnosc" className="scroll-mt-20">
              ...
              <p className="leading-relaxed text-zinc-300">
                ...
                zamieszczane przez Użytkowników. Administrator dokłada wszelkich
                starań w celu zapewnienia poprawnego działania Aplikacji, jednak
                nie ponosi odpowiedzialności za ewentualne przerwy w jej
                funkcjonowaniu.
              </p>
            </section>
            ...
            <section id="reklamacje" className="scroll-mt-20">
              ...
              <p className="leading-relaxed text-zinc-300">
                Wszelkie reklamacje dotyczące działania Aplikacji należy
                zgłaszać na adres e-mail:{" "}
                <a
                  href="mailto:support@riskradar.pl"
            ...
            <section id="postanowienia-koncowe" className="scroll-mt-20">
              ...
              <p className="leading-relaxed text-zinc-300">
                ...
                poinformowani drogą mailową. W sprawach nieuregulowanych
                niniejszym regulaminem zastosowanie mają przepisy prawa
                polskiego.
              </p>
            </section>
          </div>
