...
jest.mock("../../../src/config/config.js", () => ({
    config: { storageThresholds: { warnPercent: 50, criticalPercent: 80 }, mediaRoot: "/x" }
}))
jest.mock("../../../src/db/pool.js", () => ({ db: { health: jest.fn(async () => true) } }))
jest.mock("../../../src/domain/circuit-breaker.js", () => ({
    breakersStatus: () => [
        { name: "audit", state: "open" },
        { name: "authz", state: "half_open" }
    ]
}))
...
jest.mock("../../../src/audit/events.js", () => ({
    auditEvents: { storageThreshold: (lvl: string) => ({ service: "media", action: "storage_" + lvl }) }
}))
